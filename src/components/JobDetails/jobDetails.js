                  ...
                  <ListGroup variant="dark">
                    <ListGroup.Item className="job-items">
                      ...
                      <div className="job-title-name">
                          ...
                          <Badge bg="success"><PiBriefcaseBold />: {selectedJob.experience} </Badge>
                          <Badge bg="success"><FaWallet/>: {selectedJob.salary} </Badge>
                          </Stack>
                          <Stack direction="horizontal" gap={3}>
                            <Badge  bg="dark">{selectedJob.modeOfWork}</Badge>
                            <Badge  bg="dark">{selectedJob.jobType}</Badge>
                            <Badge bg="dark">Vacancy:  {selectedJob.vacancy}</Badge>
                          </Stack>
                          </Stack>
                      </div>
                      </div>
                    ...
                    <ListGroup.Item className="job-company">
                      ...
                      <p>{selectedJob.skillsRequired.split(',').map((skills,index)=>(
                        <Badge className="skill-badge" bg="success" key={index} >{skills}</Badge>
                      ))}</p>
                    </ListGroup.Item>
                    <ListGroup.Item className="job-company">
